      ...
      xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
          ...
          if (_this.state.result == 0) {
            ...
            _this.setState({
              result: "Invalid credentials or you have not verified your email",
            });
          } else {
            console.log("valid data");
            //_this.props.navigation.navigate("HomeScreen", {name: _this.state.result});
            _this.props.navigation.replace("HomeScreen", {
              name: _this.state.result,
            });
          }
        }
      };
      ...
      <Layaut>
        ...
        <View style={styles.loginContainer}>
          ...
          <View style={{ position: "absolute", bottom: -170, right: 0 }}>
            ...
            >
              <Text style={{ marginRight: 10, color: "#FFF" }}>Don't have an account?</Text>
              <TouchableOpacity
                title="Presiona aquí"
